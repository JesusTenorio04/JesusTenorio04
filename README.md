...
### 👨‍💻 Sobre mí:
Data Scientist certificado con background en operaciones Oil & Gas. Trabajé como Supervisor HSE en el sector PEMEX, donde aprendí de primera mano cómo se generan los datos en entornos industriales reales. Hoy combino ese contexto operativo con Python, SQL, Power BI y Tableau para convertir datos en decisiones.
...
### 👨‍💻 About me:
Certified Data Scientist with a background in Oil & Gas operations. I worked as an HSE Supervisor in the PEMEX sector, where I learned firsthand how data is generated in real industrial environments. Today I combine that operational context with Python, SQL, Power BI and Tableau to turn data into decisions.
